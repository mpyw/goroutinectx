...
//	    checkers.NewErrgroupSpawnChecker(deriveMatcher),
//	    checkers.NewWaitgroupSpawnChecker(deriveMatcher),
//	}
//
// # Execution Flow
//
...
//
//	// Fail with message
//	return internal.CheckFailed("goroutine does not propagate context")
//
//	// Fail with defer-specific message (for derive checks)
//	return internal.CheckFailedWithDefer(
